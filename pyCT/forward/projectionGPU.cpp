...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject **__pyx_pyargnames[] = {&__pyx_n_s_detector_array,&__pyx_n_s_transformation,&__pyx_n_s_object_array,&__pyx_n_s_nx,&__pyx_n_s_ny,&__pyx_n_s_nz,&__pyx_n_s_nu,&__pyx_n_s_nv,&__pyx_n_s_nw,&__pyx_n_s_na,&__pyx_n_s_su,&__pyx_n_s_sv,&__pyx_n_s_ou,&__pyx_n_s_ov,&__pyx_n_s_oa,&__pyx_n_s_s2d,&__pyx_n_s_near,&__pyx_n_s_far,0};
    if (__pyx_kwds) {
      Py_ssize_t kw_args;
      switch (__pyx_nargs) {
  ...
  __pyx_r = __pyx_pf_13projectionGPU_2projectConeBeamGPU(__pyx_self, __pyx_v_detector_array, __pyx_v_transformation, __pyx_v_object_array, __pyx_v_nx, __pyx_v_ny, __pyx_v_nz, __pyx_v_nu, __pyx_v_nv, __pyx_v_nw, __pyx_v_na, __pyx_v_su, __pyx_v_sv, __pyx_v_ou, __pyx_v_ov, __pyx_v_oa, __pyx_v_s2d, __pyx_v_near, __pyx_v_far);
 ...
 *     cdef cnp.npy_intp shape[1]
 */
  funcConeBeam(__pyx_v_c_detector_array, __pyx_v_c_transformation, __pyx_v_c_object_array, __pyx_v_nx, __pyx_v_ny, __pyx_v_nz, __pyx_v_nu, __pyx_v_nv, __pyx_v_nw, __pyx_v_na, __pyx_v_su, __pyx_v_sv, __pyx_v_c_ou, __pyx_v_c_ov, __pyx_v_c_oa, __pyx_v_s2d, __pyx_v_near, __pyx_v_far);
 ...
 *     cdef float *c_detector_array = <float *> detector_array.data
 */
  __pyx_tuple__6 = PyTuple_Pack(26, __pyx_n_s_detector_array, __pyx_n_s_transformation, __pyx_n_s_object_array, __pyx_n_s_nx, __pyx_n_s_ny, __pyx_n_s_nz, __pyx_n_s_nu, __pyx_n_s_nv, __pyx_n_s_nw, __pyx_n_s_na, __pyx_n_s_su, __pyx_n_s_sv, __pyx_n_s_ou, __pyx_n_s_ov, __pyx_n_s_oa, __pyx_n_s_s2d, __pyx_n_s_near, __pyx_n_s_far, __pyx_n_s_c_detector_array, __pyx_n_s_c_transformation, __pyx_n_s_c_object_array, __pyx_n_s_c_ou, __pyx_n_s_c_ov, __pyx_n_s_c_oa, __pyx_n_s_shape, __pyx_n_s_new); if (unlikely(!__pyx_tuple__6)) __PYX_ERR(1, 28, __pyx_L1_error)
